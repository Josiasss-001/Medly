...
class HomeActivity : AppCompatActivity() {
    ...
    private fun observarViewModel() {
        viewModel.usuario.observe(this) { usuario ->
            usuario?.let {
                // Solo se muestra el nombre (nombres), no los apellidos
                userNameTextView.text = it.nombres
                navHeaderName.text = it.nombres
            }
        }
    ...
    private fun irAActivity(className: String) {
        try {
            ...
            // Animación de desvanecimiento (Fade) para que aparezca desde el centro
